...
{[Mole Sauce]
# In a blender, combine: { [15 oz crushed tomatoes] [4 cloves garlic] [1/2 item onion [rough diced]] [1 tbl soy sauce ] [1 item chipotle chile] [1 tbl adobo sauce ] [2 tsp chili powder] [2 tsp cumin] [1/2 tsp pepper] [1/2 tsp salt]}
# Blend until smooth.
# Place this Mole sauce in a medium pot.
# Add [1/2 cup water] to the blender jar and process. Add the liquid to the pot.
# Bring mole to a simmer over medium-low heat, cover and cook over medium-low heat.
# Cook until flavors meld and the onion is tempered.
# Stir in [4 tbl tahini paste ] stir until combined. Taste, adjust salt and sweetness. Turn heat off and set aside.
}
{[Filling]
